...
install.packages(c("ellipse", "igraph", "lars", "lattice", "leaps","locfit", "MASS", "mixOmics" ))
install.packages(c("nutshell","ROCR", "statnet", "textir", "tree", "VGAM"))
library(lattice)
library(nutshell)
...
births.dow
barchart(births.dow,ylab="Day of Week",xlab="Frequency of Births",col="black")
dob.dm.tbl=table(WK=births2006.smpl$DOB_WK, MM=births2006.smpl$DMETH_REC)
dob.dm.tbl
dob.dm.tbl=dob.dm.tbl[,-2]
dob.dm.tbl
trellis.device()
barchart(dob.dm.tbl, ylab="Day of Week", xlab="Frequency of Birth")
barchart(dob.dm.tbl, horizontal=FALSE, groups=FALSE, xlab="Day of Week", ylab="Frequency Of Birth", col="black")
